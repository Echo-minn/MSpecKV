"""
This is resident layer ablation study for offloading with Quantized_MSpecKV.
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Resident layer ablation study for offloading with Quantized_MSpecKV')
...
# =============================================================================
# Resident layer ablation study for offloading with Quantized_MSpecKV
# =============================================================================
if local_rank == 0:
    print(colored("\n" + "=" * 80, "yellow"))
    print(colored("Resident layer ablation study for offloading with Quantized_MSpecKV", "yellow"))
...
for sweep_idx, resident_layers in enumerate(resident_layers_values):
    ...
    def run_mspeckv_one_setting(*, quant: bool):
        ...
        for idx, input_ids in enumerate(tqdm(
            tokenized_prompts,
            desc=f"MSpecKV_{'KVQuant' if quant else 'Baseline'}(res_layers={resident_layers})",
    ...
    if local_rank == 0:
        ...
        comparison_results['methods']['mspeckv_kv_quant']['sweep'][str(resident_layers)] = {
        ...
        print(colored(
            ...
            f"[MSpecKV][resident_layers={resident_layers}] Speedup vs MSpecKV Baseline: N/A",
            "green"
        ))
