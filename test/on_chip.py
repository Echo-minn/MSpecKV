...
from utils.decoding import Autoregressive, MSpecKV
...
if __name__ == "__main__":
    ...
    print_config(draft, target, prefill, gen_len, gamma, top_k, top_p, temperature, file_path=None, method="MSpecKV", spec_args={'budget': args.budget, 'chunk_size': chunk_size}, dataset=args.dataset)
